...
const StarredPanel = ({ onClose }) => (
  <div style={{ width: '300px', minWidth: '300px', height: '100vh', background: '#fff', borderLeft: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column' }}>
...
const ContactPanel = ({ onClose, onMediaClick, onStarredClick }) => (
  <div style={{ width: '300px', minWidth: '300px', height: '100vh', background: '#fff', borderLeft: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', overflowY: 'auto', scrollbarWidth: 'none' }}>
    {/* Header */}
    <div style={{ padding: '20px 20px 16px', display: 'flex', alignItems: 'center', gap: '14px', borderBottom: '1px solid #f3f4f6' }}>
