  ...
  return (
    <div style={{
      ...
      <div onClick={() => navigate('/')} style={{
        width: '46px', height: '46px', borderRadius: '14px',
        background: 'linear-gradient(135deg, #facc15, #4ade80, #3b82f6)',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        marginBottom: '28px', boxShadow: '0 4px 12px rgba(59,130,246,0.3)', cursor: 'pointer'
      }}>
      ...
      {/* Dark Mode Toggle */}
      <div onClick={theme.toggleDark} style={{
        ...
        <div style={{
          position: 'absolute',
          left: theme.darkMode ? 'calc(100% - 23px)' : '3px',
          top: '3px',
