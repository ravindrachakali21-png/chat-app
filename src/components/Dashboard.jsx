...
const chatData = {
  ...
  6: {
    ...
    messages: [
      ...
      { id: 3, text: 'Hahaha 😂 Ring-ding-ding!', time: '9:40', mine: true },
      { id: 4, text: 'You got it 🦊', time: '9:41', mine: false },
    ]
  },
}

const Messages = ({ theme, messages }) => (
  <div style={{ flex: 1, overflowY: 'auto', padding: '24px', scrollbarWidth: 'none', background: theme.chatBg, transition: 'background 0.3s' }}>
    {messages.map((msg) => {
      if (msg.divider) {
        return (
