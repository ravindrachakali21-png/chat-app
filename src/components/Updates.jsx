...
const responsiveStyles = `
  .updates-layout { display: flex; flex: 1; height: 100vh; }
  ...
  @media (max-width: 767px) {
    /* Left list: full screen when no story selected */
    .updates-left {
      width: 100%;
      min-width: unset;
      border-right: none;
    }
    /* Hide list when a story is open */
    .updates-left.story-open { display: none; }
    /* Right viewer: full screen */
    .updates-right {
      position: fixed;
      inset: 0;
      z-index: 40;
    ...
    .updates-right.hidden { display: none; }
    /* Story image: fill mobile height */
    .story-img { height: 100vw !important; max-height: 70vh; }
  }
`
  ...
  return (
    <>
      ...
      <div className="updates-layout">
        ...
        {/* Left Panel */}
        <div className={`updates-left${selected ? ' story-open' : ''}`}>
        ...
        {/* Right Panel */}
        <div className={`updates-right${!selected ? ' hidden' : ''}`}>
          {selected ? (
            <>
              {/* Story Header */}
              ...
              <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 40px', position: 'relative' }}>
                ...
                <div style={{ width: '340px', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.12)' }}>
                  <img className="story-img" src={statusUpdate} alt="Status" style={{ width: '100%', height: '580px', objectFit: 'cover', display: 'block' }} />
                </div>
